						...
						<div class="footer_content footer_contact">
							<ul class="contact_info_list">
								<li class="contact_info_item d-flex flex-row">
									...
									<div class="contact_info_text">20/2 Dematawa, moragane</div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="images/phone-call.svg" alt=""></div></div>
									<div class="contact_info_text">0770330330</div>
								</li>
								<li class="contact_info_item d-flex flex-row">
								...
								<li class="contact_info_item d-flex flex-row">
									...
									<div class="contact_info_text"><a href="https://colorlib.com">ashokgroup.lk</a></div>
								</li>
							</ul>
						</div>
					</div>
